...
public class TestExample {
    class SpringBootCodexBoxJava2022Batch1ApplicationTests {
        ...
        public  void testMapOperations() {
            ...
            com.codexbox.springboot.app.Veeru.Employee employee1 = new com.codexbox.springboot.app.Veeru.Employee("Bhargav", 202284, "Nellore");
            com.codexbox.springboot.app.Veeru.Employee employee2 = new com.codexbox.springboot.app.Veeru.Employee("Kalayan", 202286, "NZB");
            com.codexbox.springboot.app.Veeru.Employee employee3 = new com.codexbox.springboot.app.Veeru.Employee("Ramesh", 202290, "Ongole");

            Map<String, com.codexbox.springboot.app.Veeru.Employee> employeeMap =  new HashMap<>();
            ...
            Collection<com.codexbox.springboot.app.Veeru.Employee> employeeCollection =  employeeMap.values();

            for (com.codexbox.springboot.app.Veeru.Employee emp :  employeeCollection) {
                System.out.println("employee name is : " + emp.getName());
            }

            com.codexbox.springboot.app.Veeru.Employee emp = employeeMap.get("employee2");
            ...
            for (Map.Entry<String, com.codexbox.springboot.app.Veeru.Employee> entry : employeeMap.entrySet()) {
