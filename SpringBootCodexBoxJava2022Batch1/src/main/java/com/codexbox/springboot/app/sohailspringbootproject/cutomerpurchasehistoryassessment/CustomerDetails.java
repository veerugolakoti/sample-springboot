...
public class CustomerDetails {
    ...
    public void getCustomerDetailsTable() throws SQLException {
        ...
        try {
          ...
          /*  statement.execute("create table CustomerDetails ( id bigint Primary Key,name varchar(20),aadhar bigint,phoneNo bigint ,dateofBirth varchar(40),email varchar(30),address varchar(50))");
